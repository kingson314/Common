...
public class UtilString {
	...
	public static void addString(JTextComponent com, String str) {
		try {
			...
			text = text.substring(0, position) + str
	...
	// index : 替换位置
	public static String replaceString(String replaceString, String tostr,
			int index) {
		String rs = "";
		try {
			String begin = replaceString.substring(0, index);
			String end = replaceString.substring(index + 1, replaceString
					.length());
			rs = begin + tostr + end;
		} catch (Exception e) {
