...
public class UtilSql {
    ...
    private static void setParams(PreparedStatement ps, String dataValue, String dataType, int index, String format) throws Exception {
	try {
    ...
    private static void setParams(PreparedStatement ps, DataField dataField, String value) throws Exception {
	try {
	...
	if (objects.length > 0) {
		...
		if (null != o) {
			...
			if (o instanceof Connection)
			    ...
			    ((ResultSet) o).close();
			else if (o instanceof SqlSession)
			    ((SqlSession) o).close();
			else
			    o = null;
		    } catch (SQLException e) {
