...
public class UtilAddress {  
     ...
     */  
    public static Map<String, Object> getAddresses(String ip)  
            throws UnsupportedEncodingException {  
        // 这里调用淘宝API  
        ...
        if (returnStr != null) {  
            ...
            if(temp.length<3){  
                return UtilCollection.getMap("code",-1);//无效IP，局域网测试  
            }  
           return UtilJackSon.toObj(returnStr, new TypeReference<Map<String,Object>>() {});
        }  
        return null;  
    }  
    /** 
...
//        String address = "";  
//        try {  
//            address = new UtilAddress().getAddresses("ip="+ip, "utf-8");  
//            Map<String,Object> map=UtilJackSon.toObj(address, new TypeReference<Map<String,Object>>() {});
